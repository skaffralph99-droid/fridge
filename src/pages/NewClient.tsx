...
export default function NewClient() {
  ...
  return (
    <div className="p-4 max-w-lg mx-auto">
      ...
      <h1 className="text-xl font-black text-frost-steel mb-6">New Client</h1>
      <form onSubmit={submit} className="card space-y-4">
        ...
        <button type="submit" disabled={saving} className="btn-blue">{saving ? 'Saving...' : 'Add Client'}</button>
      </form>
    </div>
  )
}
